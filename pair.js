    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hello there PEACEMAKER MD User! 👋🏻* 
...
externalAdReply: {
title: "peace maker",
thumbnailUrl: "https://files.catbox.moe/wudmht.jpg",
...
{quoted:code })
                            ...
                            let desc = `*Don't Share with anyone this code use for deploy PEACEMAKER MD*\n\n ◦ *Github:* https://github.com/Peacemaker-cyber/Peacemaker-md`;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
